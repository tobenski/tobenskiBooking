    ...
    @if(count($dayOfWeek[$day]))
        <div class="flex flex-col md:w-4/5">
            @foreach($dayOfWeek[$day] as $index => $hour)
                <div class="md:w-full flex justify-start items-center bg-gray-100 my-1">
                    <input type="time"
                        name="opening_time"
                        id="opening_time"
                        wire:model="{{ $dayOfWeekName[$day] . '.' . $index }}.opening_time"
                    ...
                    <input type="time"
                        name="closing_time"
                        id="closing_time"
                        wire:model="{{ $dayOfWeekName[$day] . '.' . $index }}.closing_time"
                    ...
                    <div class="flex items-center ml-4">
                        <input type="checkbox"
                            name="online_booking"
                            id="online_booking"
                            wire:model="{{ $dayOfWeekName[$day] . '.' . $index }}.online_booking"
